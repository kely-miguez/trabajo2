						...
						<div id="accordion" class="wn_accordion" role="tablist">
						    <div class="card">
						        ...
						        <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
					            	<div class="card-body">
					            		<img alt="" class="user-page-logos" src="images/logo/visa.png">
													<img alt="" class="user-page-logos" src="images/logo/merc.png">
													<img alt="" class="user-page-logos" src="images/logo/pago.png">
					            	</div>
						        </div>
						    </div>
						    <div class="card">
						    ...
						    <div class="card">
						        ...
						        <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
					          		<div class="card-body">Trabajamos con:</div>
												<br>
												<img alt="" class="user-page-logos" src="images/logo/oca.png">
						        </div>
						    </div>
						    <div class="card">
