			...
			<div class="container">
				...
				<div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							...
							<div class="product__content content--center">
								<h4><a href="single-product.html">MANGA CORTA</a></h4>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.php"><img src="images/books/17.jpg" alt="product image"></a>
								<a class="second__img animation1" href="single-product.php"><img src="images/books/13.jpg" alt="product image"></a>
								<div class="hot__box color--2">
									<span class="hot-label">PRODUCTO 2</span>
								</div>
							</div>
							<div class="product__content content--center">
								<h4><a href="single-product.html">CAMPERA</a></h4>
								<ul class="prize d-flex">
									<li>$35.00</li>
									<li class="old_prize">$35.00</li>
								</ul>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.php"><img src="images/books/16.jpg" alt="product image"></a>
								<a class="second__img animation1" href="single-product.php"><img src="images/books/17.jpg" alt="product image"></a>
								<div class="hot__box">
									<span class="hot-label">PRODUCTO 3</span>
								</div>
							</div>
							<div class="product__content content--center">
								<h4><a href="single-product.html">PANTALONES</a></h4>
								<ul class="prize d-flex">
									<li>$40.00</li>
									<li class="old_prize">$35.00</li>
								</ul>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.php"><img src="images/books/18.jpg" alt="product image"></a>
								<a class="second__img animation1" href="single-product.php"><img src="images/books/19.jpg" alt="product image"></a>
								<div class="hot__box">
									<span class="hot-label">PRODUCTO 4</span>
								</div>
							</div>
							<div class="product__content content--center">
								<h4><a href="single-product.html">REMERA</a></h4>
								<ul class="prize d-flex">
									<li>$35.00</li>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.php"><img src="images/books/20.jpg" alt="product image"></a>
								<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (14).jpg" alt="product image"></a>
								<div class="hot__box">
									<span class="hot-label">PRODUCTO 5</span>
								</div>
							</div>
							<div class="product__content content--center">
								<h4><a href="single-product.php">CAMPERA</a></h4>
								<ul class="prize d-flex">
									<li>$35.00</li>
									<li class="old_prize">$35.00</li>
								</ul>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.php"><img src="images/books/100 (13).jpg" alt="product image"></a>
								<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (17).jpg" alt="product image"></a>
								<div class="hot__box">
									<span class="hot-label">PRODUCTO 6</span>
								</div>
							</div>
							<div class="product__content content--center content--center">
								<h4><a href="single-product.php">MANGA LARGA</a></h4>
								<ul class="prize d-flex">
									<li>$50.00</li>
									<li class="old_prize">$35.00</li>
								</ul>
						...
						<div class="product__indicator--4 arrows_style owl-carousel owl-theme">
							<div class="single__product">
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="single-product.php"><img src="images/books/100(24).jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (23).jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">niño</span>
											</div>
										</div>
										<div class="product__content content--center content--center">
											<h4><a href="single-product.php">niño</a></h4>
											<ul class="prize d-flex">
												<li>$50.00</li>
												<li class="old_prize">$35.00</li>
											</ul>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="single-product.php"><img src="images/books/100 (25).jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (26).jpg" alt="product image"></a>
											<div class="hot__box">
							...
							<div class="single__product">
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="single-product.php"><img src="images/books/100 (27).jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (28).jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">producto</span>
											</div>
										</div>
										<div class="product__content content--center">
											<h4><a href="single-product.html">niño</a></h4>
											<ul class="prize d-flex">
												<li>$35.00</li>
												<li class="old_prize">$35.00</li>
											</ul>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="single-product.php"><img src="images/books/100 (29).jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (30).jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">producto</span>
											</div>
										</div>
							...
							<div class="single__product">
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="single-product.php"><img src="images/books/100 (31).jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (32).jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">producto</span>
											</div>
										</div>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="single-product.php"><img src="images/books/100 (33).jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (34).jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">producto</span>
											</div>
										</div>
							...
							<div class="single__product">
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="single-product.php"><img src="images/books/100 (5).jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (6).jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">producto</span>
											</div>
										</div>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="single-product.php"><img src="images/books/100 (8).jpg" alt="product image"></a>
											<a class="second__img animation1" href="single-product.php"><img src="images/books/100 (10).jpg" alt="product image"></a>
											<div class="hot__box">
												<span class="hot-label">producto</span>
											</div>
										</div>
